...
class subjects(models.Model):
    ...
    sub_id = models.IntegerField('sub_id', null=True)
...
class questionPaperDetails(models.Model):
    ...
    sub_id = models.IntegerField('sub_id', null=True)
    sem_id=models.IntegerField('sem_id',null=True)

class generatebarcode(models.Model):
    semid = models.IntegerField('SemesterID', null=True)
    studentid = models.IntegerField('StudentID', null=True)
    courseid = models.IntegerField("CourseID", null=True)
    sub_id = models.IntegerField("SubjectID", null=True)
    empgrp = models.IntegerField("EmpGroup", null=True)
    Barcode = models.CharField("Barcode",null=True, max_length=10)
...
class detailed_marks(models.Model):
    studentid = models.IntegerField("StudentID",null=True)
    semid = models.IntegerField("SemID",null=True)
    sub_id = models.IntegerField("SubjectID",null=True)
    ...
    Evaluator = models.IntegerField("Evaluator",null=True)